"""Egusi Stew page – same layout pattern as Fufu."""
...
EGUSI_RECIPE_PATH = os.path.join(GUI_DIR, "egusi_stew.txt")


def build_egusi_page(on_home, on_start_timer):
    ...
    # Top row: home + Start cooking on the left, dish image on the right
    ...
    img_path = os.path.join(IMAGES_DIR, "egusi stew.png")
    ...
    recipe_text = _load_recipe_text(EGUSI_RECIPE_PATH)

"""Fried Rice page – same layout pattern as Fufu."""
...
FRIED_RICE_RECIPE_PATH = os.path.join(GUI_DIR, "fried_rice.txt")


def build_fried_rice_page(on_home, on_start_timer):
    ...
    img_path = os.path.join(IMAGES_DIR, "fried rice.png")
    ...
    recipe_text = _load_recipe_text(FRIED_RICE_RECIPE_PATH)
